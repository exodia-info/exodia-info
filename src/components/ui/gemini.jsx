...
const GoogleGeminiEffect = ({ title, description, className }) => {
  ...
  // Memorizziamo l'array di pathLengths
  ...
  useEffect(() => {
    ...
    const handleScroll = () => {
      ...
      pathLengths.forEach((pathLength, index) => {
        pathLength.set(
          Math.min(1, Math.max(0, 2 * scrollPercentage * (index + 1)))
        );
      });
  ...
  return (
    <div
      ref={containerRef}
      className={cn("stickContainer  relative h-[200vh]", className)}
    >
      <div className=" max-w-none flex items-center h-screen ">
        <svg
          viewBox="0 0 1440 890"
          xmlns="http://www.w3.org/2000/svg"
          className="svg w-full h-auto "
        >
          <motion.path
